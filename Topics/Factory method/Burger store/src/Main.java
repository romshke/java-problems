class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        Burger chineseBurger = burgerStore.orderBurger("cb");
        Burger americanBurger = burgerStore.orderBurger("ab");
        Burger russianBurger = burgerStore.orderBurger("rb");
    }
}
...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        return switch (type) {
            case "cb" -> new ChineseBurger("Chinese Burger");
            case "ab" -> new AmericanBurger("American Burger");
            case "rb" -> new RussianBurger("Russian Burger");
            default -> null;
        };
    }
}
